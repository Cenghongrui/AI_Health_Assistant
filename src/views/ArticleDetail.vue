  ...
  <div class="articleDetail-container">
    <div class="header-section">
      <div class="header-content">
        <el-image :src="iconURL1" alt="知识图标" class="icon" style="width: 60px; height: 60px;" />
        <h1>知识文章详情</h1>
      </div>
    </div>
    ...
    <div class="content">
      ...
      <div class="diary-card">
        ...
        <div class="tags-content" v-if="articleDetail.tagArray?.length">
          <h4>相关标签</h4>
          <div class="tags-list">
...
import iconURL1 from '@/assets/images/book.png'
import { getArticleDetail } from '@/api/frontEnd'
import dayjs from 'dayjs'
import type { ArticleDetail } from '@/interface'
...
onMounted(() => {
  ...
  getArticleDetail(props.id).then((res) => {
    articleDetail.value = {
      ...res,
      tagArray: res.tagArray ?? (res.tags ? res.tags.split(',').filter(Boolean) : []),
    }
  })
})
</script>
